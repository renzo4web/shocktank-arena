...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={
        typeof className === "function"
          ? (state) => cn("font-heading text-xl leading-none", className(state))
          : cn("font-heading text-xl leading-none", className)
      }
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      className={
        typeof className === "function"
          ? (state) => cn("text-muted-foreground text-sm", className(state))
